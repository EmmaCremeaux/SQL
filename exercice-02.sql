...
SELECT *
FROM utilisateur
INNER JOIN groupe on utilisateur.groupe_id = groupe.id;
...
VALUES
('Promo 2023', 'La promo de lannée 2023', '2023-03-15', NULL);
...
UPDATE tag
SET description = 'Le terminal Bash est linterface en ligne de commande par défaut sous Linux', name = 'Terminal Bash'
WHERE name = 'Bash';
...
-- Exo 2.10
-- Supprimez un project et toutes les relations avec ses dépendances, c-à-d les relations avec des student et 
-- les relations avec des tags :
